...
#define postTypes(int) \
  [@[ @"feature", @"bug", @"idea", @"other" ] objectAtIndex:int]
...
- (BOOL)textField:(UITextField*)textField
  ...
  } else if ([textField.restorationIdentifier
                 isEqualToString:@"descriptionTextField"]) {
...
- (void)uploadPostToParse {
  ...
  post[kPostsNumLikesKey] = @0;
  post[kPostsNumReportsKey] = @0;
  post[kPostsNumFollowersKey] = @0;
  post[kPostsNumCommentsKey] = @0;
  ...
  currentUser[@"karma"] = @([currentUser[@"karma"] intValue] + 2);
...
- (IBAction)savePressed:(id)sender {
  if ([_titleField.text isEqual:@""] || [_descriptionField.text isEqual:@""]) {
    UIAlertView* alert = [[UIAlertView alloc]
            initWithTitle:@"Missing post or title"
