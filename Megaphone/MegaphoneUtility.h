...
+ (void)reportPostInBackground:(PFObject *)post block:(void (^)(BOOL succeeded, NSError *error))completionBlock;


+ (void)likeComment:(PFObject *)post;
+ (void)unlikeComment:(PFObject *)post;
+ (void)likeCommentInBackground:(PFObject *)post block:(void (^)(BOOL succeeded, NSError *error))completionBlock;
+ (void)unlikeCommentInBackground:(PFObject *)post block:(void (^)(BOOL succeeded, NSError *error))completionBlock;
+ (void)reportCommentInBackground:(PFObject *)post block:(void (^)(BOOL succeeded, NSError *error))completionBlock;
